...
.. autoclass:: Agent
   ...
   .. autosummary::
      ...
      ~Agent.HISTORY_TRUNCATE_CHARS
      ~Agent.artifacts
      ~Agent.current_plan
      ~Agent.current_trace
      ~Agent.description
      ~Agent.filter_tools_for_task
      ~Agent.final_answer_found
      ~Agent.max_iterations
      ~Agent.max_retries
      ~Agent.msg_idx_of_new_task
      ~Agent.name
      ~Agent.persona
      ~Agent.planner
      ~Agent.purpose
      ...
      ~Agent.id
      ~Agent.tool_name_to_func
      ~Agent.tool_names
      ~Agent.chat_history
      ~Agent.usage_tracker
      ~Agent.tracer_manager
      ~Agent.observer
      ~Agent.is_visual_model
      ~Agent.task_output_files
